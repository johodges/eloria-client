#!/usr/bin/env python3
"""Write the server-side ELM for the Grey Moor barrows insides map.
...
def main() -> int:
    ...
    ap.add_argument("--package",
                    default=str(here.parents[1] / "interiors" / "grey_moors_insides"))
    ap.add_argument("--out",
                    default=str(here.parents[1] / "source-elm" / "grey_moor_barrows.elm"))
