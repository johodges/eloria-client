#!/usr/bin/env python3
"""Write the server-side ELM for the Ssarathi Ruins insides map.
...
def main() -> int:
    ...
    ap.add_argument("--package",
                    default=str(here.parents[1] / "interiors" / "ssarathi_insides"))
    ap.add_argument("--out",
                    default=str(here.parents[1] / "source-elm" / "ssarathi_royal_archive.elm"))
