#!/usr/bin/env python3
"""Write the server-side ELM for the Manymouth Delta insides map.
...
def main() -> int:
    ...
    ap.add_argument("--package",
                    default=str(here.parents[1] / "interiors" / "manymouth_delta_insides"))
    ap.add_argument("--out",
                    default=str(here.parents[1] / "source-elm" / "manymouth_flooded_labyrinth.elm"))
