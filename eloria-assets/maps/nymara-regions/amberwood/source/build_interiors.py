#!/usr/bin/env python3
"""Build the Amberwood interior map packages.
...
ROOT = Path(__file__).resolve().parents[1]           # .../amberwood
...
def export_glb(interior: I.Interior, sets, path: Path):
    builder = GLTF.GltfBuilder(generator="Eloria Amberwood interior builder")
