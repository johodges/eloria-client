#!/usr/bin/env python3
"""Write the server-side ELM for the Whitehorn Range insides map.
...
def main() -> int:
    ...
    ap.add_argument("--package",
                    default=str(here.parents[1] / "interiors" / "whitehorn_insides"))
    ap.add_argument("--out",
                    default=str(here.parents[1] / "source-elm" / "whitehorn_glacier_temple.elm"))
