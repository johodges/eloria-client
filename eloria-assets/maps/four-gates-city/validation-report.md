...
- GLB header is `glTF`, version 2; declared and actual length both 4,501,064 bytes.
- JSON parses successfully and names `four-gates-city.glb` exactly.
- 746 unique named nodes are present.
...
- Five principal convex navmesh polygons and one sanctuary off-mesh link use documented asset coordinates.
...
- This is a textured gameplay environment with close-range landmark overlays, not a hand-authored cinematic city.
- Landmark-specific unwraps, district-alley navmesh coverage, authored LOD2, and effect shaders remain future work.
