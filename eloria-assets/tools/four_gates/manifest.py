...
def build(stats: dict, bounds: dict, landmark_records: List[dict],
    ...
    return {
        ...
        "effects": effects,
        "environment": {
            "sky": {"type": "gradient", "horizon": [0.612, 0.741, 0.855],
                    "zenith": [0.204, 0.412, 0.702],
                    "groundHorizon": [0.573, 0.596, 0.573],
                    "groundBottom": [0.400, 0.400, 0.373],
                    "sunAngleMaxDegrees": 14.0},
            "sun": {"direction": [-0.40, -0.72, 0.34],
                    "color": [1.0, 0.937, 0.816], "energy": 1.22,
                    "angularDiameterDegrees": 0.6, "shadows": True},
            "ambient": {"color": [0.545, 0.588, 0.639], "energy": 0.26,
                        "skyContribution": 0.45},
            ...
            "tonemap": {"mode": "filmic", "exposure": 1.02, "whitePoint": 8.0},
