...
SPELLS=((0,"Embermend","Restore a small amount of health",5,0,(0,7),((20,1),),None),(1,"Farweave Mend","Restore health to a distant target",8,4,(4,0,7),((20,1),(37,1)),None),(2,"Aegis Veil","Raise resistance to hostile magic",10,6,(5,6,8),((35,1),(37,1)),1),(3,"Stoneward","Harden your armor for a short time",11,9,(5,3,8),((24,1),(37,1)),0),(4,"Venom Thread","Afflict a target with lingering venom",14,12,(2,4,9),((22,2),(36,1)),None),(5,"Blinkstep","Move instantly to a nearby visible place",15,15,(1,3,4),((35,1),(58,1)),None),(6,"Cinder Lance","Strike a target with focused magical force",25,20,(2,6,9),((23,2),(37,2)),None),(7,"Deep Renewal","Restore a large amount of your health",25,21,(0,7,10),((20,3),(21,1),(37,1)),None),(10,"Siphon Vitality","Steal vitality from a living target",20,27,(1,2,10),((22,2),(37,2)),None),(14,"Mindwell Draw","Draw ethereal energy from another adventurer",20,40,(1,6,11),((35,2),(37,3)),None))
...
def main():
 ...
 for sid,name,desc,mana,level,sigils,reagents,buff in SPELLS:
  ...
  spells.extend(f'      <reagent id="{uid}" uid="{uid}">{qty}</reagent>' for uid,qty in reagents)
