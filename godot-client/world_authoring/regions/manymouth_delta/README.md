...
Manymouth Delta owns the whole `western_distributary` and `eastern_distributary` features. Their connected reaches stay with these controls; island and shoreline landforms remain in the saved terrain.

Ferry landings move with their saved quay controls and are validated against the connected bank and water. No native quay or approach road is regenerated at a saved endpoint. Deleting its quay disables that ferry connection rather than restoring a generated replacement.
