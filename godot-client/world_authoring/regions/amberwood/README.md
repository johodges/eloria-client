...
Amberwood owns the complete `western_river`, `amber_tributary`, and `whitehorn_torrent` water features, including their connected continuations. Water edits do not move island or shore landforms; edit the saved terrain for those.
