...
enum ServerMessage {
	...
	# 222-247 are full - 247 is ADD_NEW_ACTOR_EXTENDED above - and 248-253
	# are stock Eternal Lands commands, so the extensions continue in the
	# unused run below them. 216-219 are free.
