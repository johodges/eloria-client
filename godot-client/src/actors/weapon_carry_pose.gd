...
## Aim the wrists after locomotion, keeping each weapon in its actual grip
## while the shoulders and elbows retain the animation's full arm swing.
...
func _process_modification_with_delta(delta: float) -> void:
	...
	for carry: Dictionary in _hands:
		...
		# and elbow motion as the unequipped arm throughout the stride.
