...
el_key_def K_SPELLPOWERUP = {SDLK_UNKNOWN, KMOD_NONE, "#K_SPELLPOWERUP"};
el_key_def K_SPELLPOWERDOWN = {SDLK_UNKNOWN, KMOD_NONE, "#K_SPELLPOWERDOWN"};
...
static el_key_def *key_def_store[] =
{
	...
	&K_ROTATERIGHT, &K_RULES, &K_SCREENSHOT, &K_SESSION, &K_SHADOWS, &K_SIGILS, &K_SIT, &K_SPELLPOWERUP, &K_SPELLPOWERDOWN, &K_SPELL1,
