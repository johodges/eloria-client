		...
		case LOG_IN_OK:
			{
				...
				safe_snprintf(str, sizeof(str),
					"%c#clientcaps actor16_v1,magic_power_v1,market_window_v1,merchant_window_v1,quest_journal_v1,item_detail_v1,inventory_window_v1,combat_hud_v1,offline_notifications_v1",
					RAW_TEXT);
				my_tcp_send((Uint8*)str, strlen(str+1)+1);
				break;
			}
